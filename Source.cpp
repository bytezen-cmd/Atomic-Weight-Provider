...
int main() {
    std::unordered_map<std::string, int> atomicWeight = {
    {"H", 1.008},   {"He", 4.002},  {"Li", 6.94},   {"Be", 9.012},
    ...
    {"Ta", 180.95}, {"W", 183.84},  {"Re", 75},     {"Os", 190.23},
    {"Ir", 192.22}, {"Pt", 195.08}, {"Au", 107.87}, {"Hg", 200.59},
	...
	std::cin >> element;
	if (atomicWeight.find(element) != atomicWeight.end()) {
		std::cout << "Atomic weight of " << element << " is " << atomicWeight[element] << std::endl;
	} else {
